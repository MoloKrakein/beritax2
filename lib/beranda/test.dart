      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          Container(
            child: ListTile(
              ...
              title: Text(
                "Beranda",
                style: TextStyle(
                    color: ColorPalette.purplelight, fontWeight: FontWeight.bold),
              ),
              onTap: () {
          ...
          Container(
            child: ListTile(
              ...
              title: Text(
                "Cari",
                style: TextStyle(
                    color: ColorPalette.purpledark, fontWeight: FontWeight.bold),
              ),
              onTap: () {
                Navigator.push(
          ...
          Container(
            child: ListTile(
              leading: CircleAvatar(
                backgroundColor: ColorPalette.purpleshadingmedium,
                child: Icon(
                Icons.category,
                color: Colors.white,
              ),
              ...
              title: Text(
                "Kategori",
                style: TextStyle(
                    color: ColorPalette.purpleshadingmedium, fontWeight: FontWeight.bold),
              ),
              onTap: () {
                 Navigator.push(
          ...
          Container(
            child: ListTile(
              leading: CircleAvatar(
                backgroundColor: ColorPalette.purpleshadingdeep,
                child:Icon(
                Icons.people,
                color: Colors.white,
              )),
              title: Text(
                "Komunitas",
                style: TextStyle(
                    color: ColorPalette.purpleshadingdeep, fontWeight: FontWeight.bold),
              ),
              onTap: () {
          ...
          Container(
            child: ListTile(
              leading: 
              CircleAvatar(
                backgroundColor: ColorPalette.purpleshadingdeeper,
                child:
                Icon(
                Icons.settings,
                color: Colors.white,
              ...
              title: Text(
                "Pengaturan",
                style: TextStyle(
                    color: ColorPalette.purpleshadingdeeper, fontWeight: FontWeight.bold),
              ),
              onTap: () {
                Navigator.pop(context);
              },
